...
// copy from https://github.com/vence722/convert library, enhance some api.

// Int2Str Convert integers to string, return empty string if the conversion fails
...
// Float2Str Convert floats to string, parameter length specifies the number of digits behind the float point, return empty string if the conversion fails
...
// Bool2Str Convert bool to string
...
// Str2Int64 Convert string to int64, panic when the string is not of a valid int64 format.
func Str2Int64(val string) int64 {
	return int64(wrapInt64Result(internalStr2Int(val, 64, false)))
}

// Str2Int64NoPanic Convert string to int64, return 0 if the conversion fails
func Str2Int64NoPanic(val string) int64 {
	return int64(wrapInt64Result(internalStr2Int(val, 64, true)))
}

// Str2Int64WithDefaultValue Convert string to int64, return the default value you set when the conversion fails
...
// Str2Int32 Convert string to int32, panic when the string is not of a valid int32 format.
func Str2Int32(val string) int32 {
	return int32(wrapInt64Result(internalStr2Int(val, 32, false)))
}

// Str2Int32NoPanic Convert string to int32, return 0 if the conversion fails
func Str2Int32NoPanic(val string) int32 {
	return int32(wrapInt64Result(internalStr2Int(val, 32, true)))
}

// Str2Int32WithDefaultValue Convert string to int32, return the default value you set when the conversion fails
...
// Str2Int16 Convert string to int16, panic when the string is not of a valid int16 format.
func Str2Int16(val string) int16 {
	return int16(wrapInt64Result(internalStr2Int(val, 16, false)))
}

// Str2Int16NoPanic Convert string to int16, return 0 if the conversion fails
func Str2Int16NoPanic(val string) int16 {
	return int16(wrapInt64Result(internalStr2Int(val, 16, true)))
}

// Str2Int16WithDefaultValue Convert string to int16, return the default value you set when the conversion fails
...
// Str2Int8 Convert string to int8, panic when the string is not of a valid int8 format.
func Str2Int8(val string) int8 {
	return int8(wrapInt64Result(internalStr2Int(val, 8, false)))
}

// Str2Int8NoPanic Convert string to int8, return 0 if the conversion fails
func Str2Int8NoPanic(val string) int8 {
	return int8(wrapInt64Result(internalStr2Int(val, 8, true)))
}

// Str2Int8WithDefaultValue Convert string to int8, return the default value you set when the conversion fails
...
// Str2Int Convert string to int, panic when the string is not of a valid int format.
func Str2Int(val string) int {
	return int(wrapInt64Result(internalStr2Int(val, 0, false)))
}

// Str2IntNoPanic Convert string to int, return 0 if the conversion fails
func Str2IntNoPanic(val string) int {
	return int(wrapInt64Result(internalStr2Int(val, 0, true)))
}

// Str2IntWithDefaultValue Convert string to int, return the default value you set when the conversion fails
...
// Str2Uint64 Convert string to uint64, panic when the string is not of a valid uint64 format.
func Str2Uint64(val string) uint64 {
	return uint64(wrapUint64Result(internalStr2Uint(val, 64, false)))
}

// Str2Uint64NoPanic Convert string to uint64, return 0 if the conversion fails
func Str2Uint64NoPanic(val string) uint64 {
	return uint64(wrapUint64Result(internalStr2Uint(val, 64, true)))
}

// Str2Uint64WithDefaultValue Convert string to uint64, return the default value you set when the conversion fails
...
// Str2Uint32 Convert string to uint32, panic when the string is not of a valid uint32 format.
func Str2Uint32(val string) uint32 {
	return uint32(wrapUint64Result(internalStr2Uint(val, 32, false)))
}

// Str2Uint32NoPanic Convert string to uint32, return 0 if the conversion fails
func Str2Uint32NoPanic(val string) uint32 {
	return uint32(wrapUint64Result(internalStr2Uint(val, 32, true)))
}

// Str2Uint32WithDefaultValue Convert string to uint32, return the default value you set when the conversion fails
...
// Str2Uint16 Convert string to uint16, panic when the string is not of a valid uint16 format.
func Str2Uint16(val string) uint16 {
	return uint16(wrapUint64Result(internalStr2Uint(val, 16, false)))
}

// Str2Uint16NoPanic Convert string to uint16, return 0 if the conversion fails
func Str2Uint16NoPanic(val string) uint16 {
	return uint16(wrapUint64Result(internalStr2Uint(val, 16, true)))
}

// Str2Uint16WithDefaultValue Convert string to uint16, return the default value you set when the conversion fails
...
// Str2Uint8 Convert string to uint8, panic when the string is not of a valid uint8 format.
func Str2Uint8(val string) uint8 {
	return uint8(wrapUint64Result(internalStr2Uint(val, 8, false)))
}

// Str2Uint8NoPanic Convert string to uint8, return 0 if the conversion fails
func Str2Uint8NoPanic(val string) uint8 {
	return uint8(wrapUint64Result(internalStr2Uint(val, 8, true)))
}

// Str2Uint8WithDefaultValue Convert string to uint16, return the default value you set when the conversion fails
...
// Str2Uint Convert string to uint, panic when the string is not of a valid uint format.
func Str2Uint(val string) uint {
	return uint(wrapUint64Result(internalStr2Uint(val, 0, false)))
}

// Str2UintNoPanic Convert string to uint, return 0 if the conversion fails
func Str2UintNoPanic(val string) uint {
	return uint(wrapUint64Result(internalStr2Uint(val, 0, true)))
}

// Str2UintWithDefaultValue Convert string to uint, return the default value you set when the conversion fails
...
// Str2Float64 Convert string to float64, panic when the string is not of a valid float64 format.
func Str2Float64(val string) float64 {
	return wrapFloat64Result(internalStr2Float(val, 64, false))
}

// Str2Float64NoPanic Convert string to float64, return 0 if the conversion fails
func Str2Float64NoPanic(val string) float64 {
	return wrapFloat64Result(internalStr2Float(val, 64, true))
}

// Str2Float64WithDefaultValue Convert string to float64, return the default value you set when the conversion fails
...
// Str2Float32 Convert string to float32, panic when the string is not of a valid float32 format.
func Str2Float32(val string) float32 {
	return float32(wrapFloat64Result(internalStr2Float(val, 32, false)))
}

// Str2Float32NoPanic Convert string to float32, return 0 if the conversion fails
func Str2Float32NoPanic(val string) float32 {
	return float32(wrapFloat64Result(internalStr2Float(val, 32, true)))
}

// Str2Float32WithDefaultValue Convert string to float32, return the default value you set when the conversion fails
...
// Bool2Int Convert bool to int, never panics
...
// Str2ByteSliceNonCopy Convert different types to byte slice using types and functions in unsafe and reflect package.
...
// BytesSlice2StrNonCopy Zero-copy convert from byte slice to a string
